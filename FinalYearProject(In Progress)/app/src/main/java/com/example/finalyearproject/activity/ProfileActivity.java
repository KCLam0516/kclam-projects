...
public class ProfileActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        TextView bDetails, bPassword, bFeedback, bService, bLogout, name, bHome, bCart, bHost;
        Button bPen;
        FrameLayout image;
        ImageView profile;
        FirebaseAuth fAuth;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            bHost=(TextView) findViewById(R.id.sHost);
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (options[item].equals("View Photo")) {       //view photo in bigger size
                            ...
                            final AlertDialog alertDialogDelete = new AlertDialog.Builder(ProfileActivity.this,R.style.AlertDialogTheme).create();
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            fileRef.delete().addOnFailureListener(new OnFailureListener() {
                                                ...
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(ProfileActivity.this, "Your photo has been deleted", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                            dialog.dismiss();
